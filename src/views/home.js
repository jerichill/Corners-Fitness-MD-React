    ...
    <div className="home-container">
          ...
          <div className="home-container02">
            <span className="home-text">
              <span className="home-text01">
                We’ve got everything you need to reach your goals from coaching
                to equipment—and everything in between.
              </span>
            </span>
            <a href="tel:443-281-8468" className="home-link">
              <span></span>
              <br></br>
              <span>(443) 281-8468</span>
            </a>
            <a href="tel:443-281-8468" className="home-link1">
              <span className="home-text05">443-281-8468</span>
            </a>
          </div>
          <img
            alt="image"
        ...
        <div className="home-container03">
          <div className="home-container04">
            <div className="home-container05">
              <h2 className="home-text06 healine">
              ...
              <span className="home-text09 textXL">
                ...
                <span>
                  ...
                  apart from other gyms is the people inside our four walls. Our
                  goal is to help you tackle anything that stands in the way of
                  a healthier you, together. We know fitness journeys don’t
                  follow a straight line and our coaches are fluent in helping
                  you get back on track after detours.
                </span>
              </span>
            </div>
            <iframe
          ...
          <div className="home-cards-container">
            <div className="home-card1">
              ...
              <h6 className="home-text12 textXL">Gym Amenities</h6>
            ...
            <div className="home-card2">
              ...
              <h6 className="home-text14 textXL">Fitness Classes</h6>
              <span className="home-text15">
                Group Fitness, Personal Training, (VOD) Video on Demand Classes
              </span>
            </div>
            <div className="home-card3">
              ...
              <h6 className="home-text16 textXL">Online Training</h6>
          ...
          <div className="home-work-with-us">
            <div className="home-container09">
              ...
              <h3 className="home-text18 healine">Why 4Corners Fitness</h3>
      ...
      <div className="home-section3">
        <div className="home-container45">
          <h6 className="home-text39 textSM">
            <span>ON THE COASTLINE</span>
          </h6>
          <h3 className="home-text41 healine">We are missing the summer</h3>
          <span className="home-text42 textXL">
          ...
          <div className="home-services">
            ...
            <div className="home-container46">
              ...
              <h1 className="home-text44 textXL">Grow your market</h1>
            ...
            <div className="home-container48">
              ...
              <h1 className="home-text46 textXL">Launch time</h1>
          ...
          <div className="home-contact">
            ...
            <h2 className="home-text48">Type in the bellow form</h2>
            <span className="home-text49 textXL">
            ...
            <div className="home-form">
              <h1 className="home-text50">Want to work with us?</h1>
              <span className="home-text51 textXL">
                Complete this form and we will get back to you in 24 hours.
              </span>
              <span className="home-text52 textXS">FULL NAME</span>
              <input
                type="text"
                placeholder="Full Name"
                className="home-textinput textSM input"
              />
              <span className="home-text53 textXS">EMAIL</span>
              <input
                type="text"
                placeholder="Email"
                className="home-textinput1 textSM input"
              />
              <span className="home-text54 textXS">MESSAGE</span>
              <textarea
                cols="80"
                rows="4"
                disabled="true"
